...
class DropdownSearchState<T> extends State<CustomDropDown<T>> {
...
// to exit dropdown input
  Widget _defaultSelectItemWidget(T data) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: <Widget>[
        Expanded(
          child: widget.dropdownBuilder != null ? widget.dropdownBuilder(context, data, _selectedItemAsString(data),)
              : Text(_selectedItemAsString(data),style: widget.inputStyle,overflow: TextOverflow.ellipsis,),
        ),
